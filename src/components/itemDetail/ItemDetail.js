...
const ItemDetail = ( {id, name, img, desc, price, category, stock, link} ) => {
    ...
    return (
        ...
        <div className="container box-border border-4 inline-flex flex-grow justify-center content-center sm:flex-wrap md:flex-nowrap">
            <div className="box-border my-3 mx-4 text-center justify-items-between py-4 px-4 shadow-2xl self-center font-semibold">
                <img className = "rounded-md shadow-2xl w-54 h-54" src={img} alt={name}/>
            ...
            <div className="container flex-grow box-border my-3 mx-4 text-center py-4 px-4 shadow-2xl ">
                ...
                <p className = ""><span className = "mb-4 font-semibold">Tema: </span>{desc}</p>
                <p className = ""><span className = "mb-4 font-semibold">Link de acceso: </span> {link}</p>
                {
                    !isInCart(id)
                        ?   <ItemCount 
                                max= {stock}
                        ...
                        :   <div className='p-6 flex justify-center flex-wrap'>
                                ...
                                <NavLink to="/" className='flex ml-2 mt-2 p-2 rounded-md shadow-lg ring-1 ring-white ring-opacity-5 focus:outline-none bg-gray-600 text-white hover:bg-gray-400'> 
