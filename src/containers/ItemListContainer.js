        ...
        {items.length !== 0 ? <div>
                                ...
                                <div className=" box-border border-t-8 border-b-8 pb-8 border-gray-600 md:mt-20 mb-20 pt-10 md:pt-0 lg:pt-10 pl-4 md:pd-14 lg:pl-20 text-left flex-row justify-around shadow-2xl ">
                                    ...
                                    <button
                                        ...
                                        onClick={nextPage}
                                        disabled={currentPage===maxItems}>
                                            Siguiente
                                    </button>
                                    <div className="box-border border-t-8 border-b-8 pb-2 border-gray-600 my-2 py-4 text-left flex-row justify-around shadow-2xl ">
